...
//     totalBeaches: 59, // Schimbat de la 23 la 59
//     totalRevenue: 45620,
...
//     { id: 'RZ001', user: 'Ion Popescu', beach: 'Plaja Mamaia Nord', date: '2025-05-24', status: 'confirmed', amount: 150 },
//     { id: 'RZ002', user: 'Maria Ionescu', beach: 'Plaja Eforie Sud', date: '2025-05-24', status: 'pending', amount: 120 },
//     { id: 'RZ003', user: 'Andrei Georgescu', beach: 'Plaja Costinești', date: '2025-05-25', status: 'confirmed', amount: 200 },
//     { id: 'RZ004', user: 'Elena Radu', beach: 'Plaja Vama Veche', date: '2025-05-25', status: 'cancelled', amount: 180 }
//   ];

//   const menuItems = [
//     { id: 'dashboard', label: 'Dashboard', icon: 'dashboard', link: '/admin/dashboard' },
//     { id: 'users', label: 'Utilizatori', icon: 'users', link: '/admin/utilizatori' },
//     { 
//       id: 'manager-requests', 
//       label: 'Cereri Manageri', 
//       icon: 'alertTriangle', 
//       link: '/admin/cereri-manageri'
//     },
//     { id: 'beaches', label: 'Plaje', icon: 'beach', link: '/admin/plaje' },
//    // { id: 'equipment-prices', label: 'Preturi echipamente', icon: 'money', link: '/admin/preturi-echipamente' },
//     { id: 'reservations', label: 'Rezervări', icon: 'ticket', link: '/admin/rezervari' },
//     { id: 'equipment', label: 'Echipamente', icon: 'umbrella', link: '/admin/echipamente' },
//     { id: 'companies', label: 'Firme', icon: 'building', link: '/admin/firme' },
//     { id: 'statistics', label: 'Statistici', icon: 'chart', link: '/admin/statistici' },
//     { id: 'settings', label: 'Setări', icon: 'settings', link: '/admin/setari' }
//   ];

//   // Funcția de logout corectată
//   const handleLogout = async () => {
//     try {
//       console.log('🚪 Începere proces logout...');
      
//       // 1. Șterge toate datele din localStorage
...
//       // 2. Dacă ai funcția logout din AuthContext, folosește-o
//       // Decomentează linia de mai jos când integrezi în aplicația ta
//       // if (logout) {
//       //   await logout();
//       //   console.log('🔓 Logout executat prin AuthContext');
//       // }
      
//       // 3. Forțează o pauză pentru a permite actualizarea stării
//       await new Promise(resolve => setTimeout(resolve, 100));
      
//       // 4. Redirecționează folosind replace pentru a nu permite back navigation
//       console.log('🔄 Redirecționez către /login...');
//       navigate('/login', { replace: true });
      
//       // 5. Forțează refresh-ul paginii pentru a reseta complet starea
//       setTimeout(() => {
...
//       // Fallback: forțează redirecționarea
//       window.location.href = '/login';
//     }
//   };
...
//             value={dashboardStats.totalReservations.toLocaleString()} 
...
//             value={dashboardStats.totalBeaches} 
//             icon="beach"
//             color="info"
//           />
//         </div>
...
//           <StatCard 
//             title="Venit Total" 
//             value={`${dashboardStats.totalRevenue.toLocaleString()} RON`} 
//             change={dashboardStats.revenueGrowth}
//             changeType="up"
//             icon="chart"
//             color="warning"
...
//                            reservation.status === 'pending' ? 'În așteptare' : 'Anulată'}
//                         </span>
//                       </td>
//                       <td>{reservation.amount} RON</td>
//                       <td>
...
//               <div className="text-white fw-bold" style={{ fontSize: '14px' }}>Admin User</div>
//               <div className="text-muted" style={{ fontSize: '12px' }}>admin@sunnyseat.ro</div>
//             </div>
//           </div>
//           <button 
...
//                   <small className="d-block fw-bold">Administrator</small>
//                   <small className="text-muted">Activ acum</small>
//                 </div>
    ...
    <div>
      ...
      <div className="row g-4 mb-4">
        <div className="col-md-3">
          <StatCard 
            title="Total Utilizatori" 
            value={isLoading ? '...' : formatNumber(dashboardStats.totalUsers)} 
            change={dashboardStats.userGrowth}
            changeType={dashboardStats.userGrowth >= 0 ? 'up' : 'down'}
            icon="users"
            color="primary"
            isLoading={isLoading}
          />
