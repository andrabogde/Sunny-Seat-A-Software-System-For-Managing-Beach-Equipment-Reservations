...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentation.LoginRequestDto();
  });
  ...
  describe('LoginRequestDto', function() {
    it('should create an instance of LoginRequestDto', function() {
      ...
      //var instance = new ApiDocumentation.LoginRequestDto();
      //expect(instance).to.be.a(ApiDocumentation.LoginRequestDto);
    });
