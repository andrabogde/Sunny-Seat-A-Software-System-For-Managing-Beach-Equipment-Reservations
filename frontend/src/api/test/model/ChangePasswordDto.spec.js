...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentation.ChangePasswordDto();
  });
  ...
  describe('ChangePasswordDto', function() {
    it('should create an instance of ChangePasswordDto', function() {
      ...
      //var instance = new ApiDocumentation.ChangePasswordDto();
      //expect(instance).to.be.a(ApiDocumentation.ChangePasswordDto);
    });
