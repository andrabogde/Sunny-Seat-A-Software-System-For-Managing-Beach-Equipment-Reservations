...
(function(root, factory) {
  ...
  describe('UserDto', function() {
    it('should create an instance of UserDto', function() {
      ...
      //var instance = new ApiDocumentation.UserDto();
    ...
    it('should have the property o2AuthInfo (base name: "o2AuthInfo")', function() {
      // uncomment below and update the code to test the property o2AuthInfo
      //var instance = new ApiDocumentation.UserDto();
      //expect(instance).to.be();
    });
