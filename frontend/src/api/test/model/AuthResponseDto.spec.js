...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentation.AuthResponseDto();
  });
  ...
  describe('AuthResponseDto', function() {
    it('should create an instance of AuthResponseDto', function() {
      // uncomment below and update the code to test AuthResponseDto
      //var instance = new ApiDocumentation.AuthResponseDto();
      //expect(instance).to.be.a(ApiDocumentation.AuthResponseDto);
    });
